...
S3 <- subset(x = S3, subset = nFeature_RNA > 500 & nFeature_RNA < 2500 & 
               S3.percent.mito >  -Inf & S3.percent.mito < 0.05)
#S3 <- subset(x=S3, subset = S3.percent.ribo >  -Inf & S3.percent.ribo < 0.05) 
               #S3.percent.ribo >  -Inf & S3.percent.ribo < 0.05 &
               #S3.percent.hsp >  -Inf & S3.percent.hsp < 0.05)
